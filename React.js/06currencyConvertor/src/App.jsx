...
function App() {
    ...
    const [from, setFrom] = useState("usd") //Given By-default so that it will not crash 
                    ...
                    >
                        ...
                        <div className="w-full mt-1 mb-4 text-black">
                            <InputBox
                                ...
                                selectCurrency={to}
                                amountDisable // Passing true by default
                                
                            />
                        </div>
                        <button type="submit" className="w-full bg-blue-600  px-4 py-3 rounded-lg" onClick={convert}>
